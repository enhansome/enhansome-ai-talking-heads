# Awesome talking-head with stars
...
* [SadTalker](https://github.com/OpenTalker/SadTalker) ⭐ 14,065 | 🐛 665 | 🌐 Python | 📅 2024-06-26 : Learning Realistic 3D Motion Coefficients for Stylized Audio-Driven Single Image Talking Face Animation. 🎭🎶
...
* [Thin-Plate-Spline-Motion-Model](https://github.com/yoyo-nb/Thin-Plate-Spline-Motion-Model) ⭐ 3,606 | 🐛 79 | 🌐 Jupyter Notebook | 📅 2024-02-10 : Thin-Plate Spline Motion Model for Image Animation. 🖼️
* [GeneFace](https://github.com/yerfor/GeneFace) ⭐ 2,660 | 🐛 102 | 🌐 Python | 📅 2024-10-18 : Generalized and High-Fidelity 3D Talking Face Synthesis; ICLR 2023; Official code. 👤💬
* [sd-wav2lip-uhq](https://github.com/numz/sd-wav2lip-uhq) ⭐ 1,423 | 🐛 72 | 🌐 Python | 📅 2024-06-14 : Wav2Lip UHQ extension for Automatic. 👄
...
* [Audio2Head](https://github.com/wangsuzhen/Audio2Head) ⭐ 351 | 🐛 13 | 🌐 Python | 📅 2024-02-15 : Code for paper "Audio2Head: Audio-driven One-shot Talking-head Generation with Natural Head Motion" in the conference of IJCAI 2021. 🗣️👤
...
- [Wunjo AI](https://github.com/wladradchenko/wunjo.wladradchenko.ru) ⭐ 1,170 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-25 : Synthesize & clone voices in English, Russian & Chinese, real-time speech recognition, deepfake face & lips animation, face swap with one photo, change video by text prompts, segmentation, and retouching. Open-source, local & free. 🗣️👤💬
- [IP\_LAP](https://github.com/Weizhi-Zhong/IP_LAP) ⭐ 733 | 🐛 43 | 🌐 Python | 📅 2024-01-06 : CVPR2023 talking face implementation for Identity-Preserving Talking Face Generation With Landmark and Appearance Priors. 🔥🤖
- [LIHQ](https://github.com/johnGettings/LIHQ) ⭐ 264 | 🐛 5 | 🌐 Python | 📅 2023-07-03 : Long-Inference, High Quality Synthetic Speaker (AI avatar/ AI presenter). 🎙️👤
- [ICCV2023-MCNET](https://github.com/harlanhong/ICCV2023-MCNET) ⭐ 252 | 🐛 14 | 🌐 Python | 📅 2023-10-05 : The official code of our ICCV2023 work: Implicit Identity Representation Conditioned Memory Compensation Network for Talking Head video Generation. 🎥🤖
- [Co-Speech-Motion-Generation](https://github.com/TheTempAccount/Co-Speech-Motion-Generation) ⭐ 210 | 🐛 22 | 🌐 Python | 📅 2022-11-12 : Freeform Body Motion Generation from Speech. 🗣️🚶
- [Neural Head Reenactment with Latent Pose Descriptors](https://github.com/shrubb/latent-pose-reenactment) ⭐ 181 | 🐛 6 | 🌐 Python | 📅 2023-03-14 : The authors' implementation of the "Neural Head Reenactment with Latent Pose Descriptors" (CVPR 2020) paper. 🤖👤
- [NED](https://github.com/foivospar/NED) ⭐ 160 | 🐛 6 | 🌐 Python | 📅 2022-10-06 : PyTorch implementation for NED (CVPR 2022). It can be used to manipulate the facial emotions of actors in videos based on emotion labels or reference styles. 😃🎭🎥
- [WACV23\_TSNet](https://github.com/nihaomiao/WACV23_TSNet) ⭐ 148 | 🐛 1 | 🌐 Python | 📅 2023-09-08 : The pytorch implementation of our WACV23 paper "Cross-identity Video Motion Retargeting with Joint Transformation and Synthesis". 🎬✨
- [Speech2Video](https://github.com/sibozhang/Speech2Video) ⚠️ Archived : Code for ACCV 2020 "Speech2Video Synthesis with 3D Skeleton Regularization and Expressive Body Poses". 🗣️🎥💃
...
* [face3D\_chung](https://sourceforge.net/projects/face3dchung/): Create 3D character avatar head objects with texture from a single photo for your games. 🎮
...
* [Best Open Source BASIC 3D Modeling Software](https://sourceforge.net/directory/3d-modeling/basic/) : Includes talk3D\_chung, a small example using obj models created with face3D\_chung, and speak3D\_chung\_dll, a dll to load and display face3D\_chung talking avatars. (🛠️🎭)
